...
const Login = () => {
  const { login, register, isLoading } = useLogin();
  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-br from-green-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-6xl relative">
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden relative transition-colors duration-300">
          <div className="flex flex-col md:flex-row relative">
            
            {/* Panel Informativo */}
            <div 
              className={`bg-gradient-to-br from-green-500 to-green-700 dark:from-green-600 dark:to-green-900 p-8 md:p-12 text-white overflow-hidden transition-all duration-700 ease-in-out
            ...
            {/* Panel de Formulario */}
            <div 
              className={`w-full md:w-1/2 p-6 md:p-8 lg:p-12 flex flex-col justify-center transition-all duration-700 ease-in-out relative z-20 bg-white dark:bg-gray-800
                ${isLogin ? 'md:ml-auto' : 'md:mr-auto'}
              `}
            >
              {/* Logo móvil */}
              <div 
                className="md:hidden flex items-center justify-center space-x-2 mb-6"
              >
              ...
              <form onSubmit={handleSubmit} className={`space-y-4 transition-all duration-500 ${isAnimating ? 'opacity-0 blur-sm translate-x-8' : 'opacity-100 blur-0 translate-x-0'}`}>
                ...
                {!isLogin && (
                  <div className="group">
                    ...
                    <div className="relative">
                      <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 group-focus-within:text-green-500 transition-colors w-5 h-5" />
                      <input
                        type="text"
                        name="name"
                        value={formData.name}
                        onChange={handleInputChange}
                        className="w-full pl-12 pr-4 py-2.5 md:py-3 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-100 dark:focus:ring-green-900 transition-all outline-none text-sm md:text-base"
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 group-focus-within:text-green-500 transition-colors w-5 h-5" />
                    <input
                      type="email"
                      name="email"
                ...
                {!isLogin && (
                  <div className="group">
                    ...
                    <div className="relative">
                      <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 group-focus-within:text-green-500 transition-colors w-5 h-5" />
                      <input
                        type="tel"
                        name="phone"
                ...
                {!isLogin && (
                  <div className="flex items-start gap-3 py-2">
                    <input
                      ...
                      className="w-4 h-4 mt-1 text-green-500 border-gray-300 dark:border-gray-600 rounded focus:ring-green-500 cursor-pointer"
                      required={!isLogin}
                    />
                    <label htmlFor="terms" className="text-sm text-gray-600 dark:text-gray-300 cursor-pointer">
                      Acepto los{' '}
                      <a href="#" className="text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-semibold transition-colors">
                ...
                {isLogin && (
                  <div className="flex items-center justify-between">
                    <label className="flex items-center cursor-pointer group">
                      <input 
                        type="checkbox" 
                        className="w-4 h-4 text-green-500 border-gray-300 dark:border-gray-600 rounded focus:ring-green-500 cursor-pointer"
                      />
                      <span className="ml-2 text-sm text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white">
                        Recordarme
                      </span>
                    </label>
                    <a 
              ...
              <div className={`mt-6 md:mt-8 text-center transition-all duration-500 ${isAnimating ? 'opacity-0 blur-sm' : 'opacity-100 blur-0'}`}>
                <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">
                  ...
                  <button
                    onClick={toggleMode}
                    className="ml-2 text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-bold transition-colors"
                  >
              ...
              <div className={`grid grid-cols-2 gap-3 md:gap-4 transition-all duration-500 ${isAnimating ? 'opacity-0 blur-sm' : 'opacity-100 blur-0'}`}>
                <button className="flex items-center justify-center gap-2 px-3 md:px-4 py-2.5 md:py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl hover:border-gray-300 dark:hover:border-gray-500 hover:shadow-md transition-all group bg-white dark:bg-gray-700">
                  ...
                  <span className="text-gray-700 dark:text-gray-200 font-medium text-sm md:text-base">Google</span>
                </button>
                ...
                <button className="flex items-center justify-center gap-2 px-3 md:px-4 py-2.5 md:py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl hover:border-gray-300 dark:hover:border-gray-500 hover:shadow-md transition-all group bg-white dark:bg-gray-700">
                  ...
                  <span className="text-gray-700 dark:text-gray-200 font-medium text-sm md:text-base">Facebook</span>
                </button>
              </div>
            </div>
          </div>
